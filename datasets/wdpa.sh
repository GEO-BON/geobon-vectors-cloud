...
ogr2ogr -f Parquet /data/wdpa.gpkg /data/wdpa_dec2025_public/WDPA_Dec2025_Public.gdb ogr2ogr -f Parquet /data/wdpa.gpkg /data/wdpa_dec2025_public/WDPA_Dec2025_Public.gdb WDPA_Dec2025_Public -lco GEOMETRY=AS_WKB -nlt PROMOTE_TO_MULTI -nln wdpa -lco GEOMETRY=AS_WKB -nlt PROMOTE_TO_MULTI -nln wdpa
